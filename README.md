...
- If you encounter a character not in the character set, it should be translated as itself. Using the example above, “hello world!” should be translated as “keder ohulw!” Please note that the shift are still assigned to this character - it is just not getting translated.
